...
## **Venompred 2.0** is available within the MolBook Pro software. 
#### Request the demo of software at the following page:
https://molbookpro.farm.unipi.it/

## Alternatively, VenomPred 2.0 can be accessed directly at the following page:
https://www.mmvsl.it/wp/venompred2/
