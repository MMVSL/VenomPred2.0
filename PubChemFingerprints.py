    ...
    for ring in AllRingsBond:
        ...
        for bondIdx in ring:
            ...
            if BeginAtom.GetAtomicNum() != 6 or EndAtom.GetAtomicNum() != 6:
                ...
                break
        ######## counting
        if (nonsingle == False or aromatic == True) and AllCarb == True:
            ringSize.append(len(ring))
            for k, v in temp.items():
                if len(ring) == k:
                    temp[k] += 1
    ...
    for ring in AllRingsBond:
        ...
        for bondIdx in ring:
            ...
            if BeginAtom.GetAtomicNum() == 7 or EndAtom.GetAtomicNum() == 7:
                ...
                break
        ######## counting
        if (nonsingle == False or aromatic == True) and ContainNitro == True:
            ringSize.append(len(ring))
            for k, v in temp.items():
                if len(ring) == k:
                    temp[k] += 1
    ...
    for ring in AllRingsBond:
        ...
        for bondIdx in ring:
            ...
            if BeginAtom.GetAtomicNum() not in [1, 6] or EndAtom.GetAtomicNum() not in [1, 6]:
                ...
                break
        ######## counting
        if (nonsingle == False or aromatic == True) and heteroatom == True:
            ringSize.append(len(ring))
            for k, v in temp.items():
                if len(ring) == k:
                    temp[k] += 1
